...
CREATE TABLE auth_group_permissions (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY auth_group_permissions_group_id_permission_id (group_id),
...
CREATE TABLE auth_user_groups (
  ...
  group_id int NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY auth_user_groups_user_id_group_id (user_id),
...
CREATE TABLE auth_user_user_permissions (
  ...
  permission_id int NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY auth_user_user_permissions_user_id_permission_id (user_id),
  KEY auth_user_user_permi_permission_id_fk_auth_perm (permission_id),
...
CREATE TABLE api_tbl_produtos (
  id int NOT NULL AUTO_INCREMENT,
  nome_produto varchar(200) NOT NULL,
  preco_produto double NOT NULL,
  disponivel_produto tinyint(1) NOT NULL,
  deletado tinyint(1) NOT NULL,
  PRIMARY KEY (id)
);

CREATE TABLE api_tbl_inventarios (
  id int NOT NULL AUTO_INCREMENT,
